...
Zoom, which has somehow become the default choice for online teaching, embodies all of these attributes. It’s a particularly good example of how institutional power structures are hard-coded into these apps, beginning with who gets to control the knowledge about what’s happening on the platform3:
...
But the most dystopian Zoom feature of all has to be Attendee attention tracking. In a 2018 article4 the company describes the feature and its potential use in an educational context as follows:
...
This was first published in Content Free.
{% endfootnotes %}