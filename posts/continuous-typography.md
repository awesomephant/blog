...
{% include fig.liquid, src: "/assets/continuous-type/function-wave.svg", alt: "A curved plane is drawn on a 3d coordinate system. Caption reads: Font size = f(x,y).", class: "medium" %}
